...
{
    public partial class LogisticPartner : Form
    {
        ...
        private void LogisticPartner_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'passport_dbDataSet3.Applicant' table. You can move, or remove it, as needed.
            this.applicantTableAdapter.Fill(this.passport_dbDataSet3.Applicant);
